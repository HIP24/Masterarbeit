...
#line 1236 "sqlhist.tab.c"
    break;

  case 4: /* label: name  */
#line 79 "sqlhist.y"
        { CHECK_RETURN_PTR((yyval.string) = store_str(sb, (yyvsp[0].string))); }
#line 1242 "sqlhist.tab.c"
    break;

  case 5: /* select: SELECT  */
#line 82 "sqlhist.y"
                 { table_start(sb); }
#line 1248 "sqlhist.tab.c"
    break;
