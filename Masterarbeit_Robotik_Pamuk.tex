...
\outline{Sections \ref{sec:salamander4-bare-metal} and \ref{sec:salamander4-virtualisation}  demonstrate the inital real-time latency values gathered for bare metal and virtualisation. 
}
...
\noindent The inital QEMU script after the custom Yocto build and the starting point for this work is shown in Code \ref{script:qemu_def}. This script will be adjusted in the course of this thesis in order to accompany real-time performance tunings.   
