...
Figure \ref{fig:gnuplot_max_latency_default} depicts the variation in latency over the course of said time. 
...
\begin{table}[h]
	...
	\begin{tabular}{|c|c|}\hline
	\textbf{Statistic} & \textbf{Value (in \textmu s)} \\\hline
	Average Latency & 174.5us \\\hline
	Maximum Latency & 4070.02us \\\hline
	Minimum Latency & 6.96us \\\hline
	Standard Deviation & 359.27us \\\hline
	\end{tabular}
	\end{table}
...
\subsection{Disable simultaneous multithreading}
Disable
