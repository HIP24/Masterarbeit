...
\bigskip \noindent \citeauthor{taccariEmbeddedRealTimeVirtualization2014} \cite{taccariEmbeddedRealTimeVirtualization2014}, \citeauthor{sandstromVirtualizationTechnologiesEmbedded2013} \cite{sandstromVirtualizationTechnologiesEmbedded2013}, and \citeauthor{guStateoftheArtSurveyRealTime2012} \cite{guStateoftheArtSurveyRealTime2012} all discuss and compare the current state-of-the-art in virtualization technologies on embedded real-time platforms. 

highlighting similar advancements and challenges in their respective works.

\bigskip \noindent 
\citeauthor{garcia-vallsChallengesRealtimeVirtualization2014} \cite{garcia-vallsChallengesRealtimeVirtualization2014}
