...
\begin{table}[h]
	...
	\begin{itemize}
		\item \textbf{Hyper Threading}: Explain
		\item \textbf{Intel SpeedStep}: Explain
		\item \textbf{Intel® Speed Shift Technology}: Explain
		\item \textbf{C States}: Explain
		\item \textbf{VT-d}: Explain
	\end{itemize}
