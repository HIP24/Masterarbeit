...
\textcolor{red}{After the BIOS configurations, Figure \ref{fig:max_latency_rt}}
...
\textcolor{red}{After the Kernel configurations, Figure \ref{fig:max_latency_rt_kernelparam}}
