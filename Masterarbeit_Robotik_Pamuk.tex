...
BIOS is firmware used to perform hardware initialization during the booting process. Some BIOS settings can have a significant impact on the real-time performance of the system. The configurations in Table 4 are tuned for real-time performance.
