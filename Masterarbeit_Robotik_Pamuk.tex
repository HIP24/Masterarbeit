...
\begin{itemize}
	...
	\item The goal is to virtualize Salamander 4 and approach the performance of bare metal through real-time performance tunings, focussing on latency requirements set by SIGMATEK.
	      These modifications are subject of Chapter~\ref{cha:real-time_tunings}.
...
\chapter{Theoretical Foundations}\label{cha:theoretical_foundations}
...
\chapter{Real-Time Performance Tuning}\label{cha:real-time_tunings}
