...
This master's thesis was written at SIGMATEK GmbH \& Co KG \cite{pixelartSIGMATEKKompletteAutomatisierungssysteme}. This section provides necessary information about the starting point and boundary conditions of the thesis, as the work should be reproducible with the means used.

SIGMATEK uses its own customized Linux distribution to be run on their self-manufactured CPUs, namely Salamander 4. This operating system


, to employ hard real-time in their Salamander4 is virtualized through third party services.


The details of this operating system are explained in section \ref{sec:salamander4}
