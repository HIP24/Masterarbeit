...
\begin{figure}[H]
	...
	\caption[kvm exits default]{power\_saver kvm\_exit\_count}
...
\begin{figure}[H]
	...
	\caption[kvm exits default]{power\_saver host report}
...
\begin{figure}[H]
	...
	\caption[kvm exits default]{power\_saver guest report}
...
\begin{figure}[H]
	...
	\caption[kvm exits default]{balanced kvm\_exit\_count}
...
\begin{figure}[H]
	...
	\caption[kvm exits default]{balanced host report}
...
\begin{figure}[H]
	...
	\caption[kvm exits default]{balanced guest report}
...
\begin{figure}[H]
	...
	\caption[kvm exits default]{performance \_exit\_count}
...
\begin{figure}[H]
	...
	\caption[kvm exits default]{performance host report}
