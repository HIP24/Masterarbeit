...
set output 'gnuplot_max_latency_rt_kernelparam_host.png'
set encoding utf8
...
plot 'max_latency_rt_kernelparam_host_10min.txt' using 1:2 with lines linewidth 3 linecolor rgb "#f29105" title ''
```

![gnuplot_max_latency_rt_kernelparam_host.png](gnuplot_max_latency_rt_kernelparam_host.png)