...
set output 'gnuplot_max_latency_rt_kernelparam.png'
set encoding utf8
...
plot 'max_latency_rt_kernelparam_10min.txt' using 1:2 with lines linewidth 3 linecolor rgb "#298a24" title ''
```

![gnuplot_max_latency_rt_kernelparam.png](gnuplot_max_latency_rt_kernelparam.png)